	<div id="navbar">
		...
		<ul class="navigation">
			<?php
				if(isset($_SESSION['role']) and in_array('ROLE_USER', $_SESSION['role'])) {
					echo <<<EOT
...
EOT;
            ...
            if(isset($_SESSION['role']) and in_array('ROLE_ADMIN', $_SESSION['role'])) {
                echo <<<EOT
                    <li> <h3> PANEL ADMINA: </h3> </li>
					<li> <a href='?page=approvePost' class='navigation-link'> ZATWIERŹ POSTY </a>
EOT;
            }
			?>
		</ul>
